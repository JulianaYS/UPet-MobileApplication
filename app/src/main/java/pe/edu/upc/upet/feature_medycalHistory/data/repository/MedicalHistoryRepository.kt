package pe.edu.upc.upet.feature_medycalHistory.data.repository
...
import pe.edu.upc.upet.feature_medycalHistory.data.remote.MedicalHistoryService
import pe.edu.upc.upet.feature_medycalHistory.data.remote.MedicalHistoryServiceFactory
...
class MedicalHistoryRepository(
    ...
    fun getAllMedicalHistories(callback: (List<MedicalHistoryResponse>?)->Unit){
        medicalHistoryService.getAllMedicalHistories().enqueue(object :
            ...
            override fun onResponse(call: Call<List<MedicalHistoryResponse>>, response: Response<List<MedicalHistoryResponse>>) {
    ...
    fun createMedicalHistory(medicalHistory: MedicalHistoryRequest, callback: (Boolean)->Unit){
        medicalHistoryService.createMedicalHistory(medicalHistory).enqueue(object :
            ...
            override fun onResponse(call: Call<MedicalHistoryResponse>, response: Response<MedicalHistoryResponse>) {
                if (response.isSuccessful) {
                    callback(true)
                } else {
                    callback(false)
    ...
    fun addMedicalResultToMedicalHistory(medicalHistoryId: Int, medicalResult: MedicalResultRequest, callback: (Boolean)->Unit){
        medicalHistoryService.addMedicalResultToMedicalHistory(medicalHistoryId, medicalResult).enqueue(object :
            Callback<MedicalResultResponse> {
            override fun onResponse(call: Call<MedicalResultResponse>, response: Response<MedicalResultResponse>) {
                if (response.isSuccessful) {
                    callback(true)
                } else {
                    callback(false)
    ...
    fun getAllMedicalResultsByMedicalHistoryId(medicalHistoryId: Int, callback: (List<MedicalResultResponse>?)->Unit){
        medicalHistoryService.getAllMedicalResultsByMedicalHistoryId(medicalHistoryId).enqueue(object :
            Callback<List<MedicalResultResponse>> {
            override fun onResponse(call: Call<List<MedicalResultResponse>>, response: Response<List<MedicalResultResponse>>) {
                if (response.isSuccessful) {
                    callback(response.body())
                } else {
                    callback(null)
    ...
    fun addDiseaseToMedicalHistory(medicalHistoryId: Int, disease: DiseaseRequest, callback: (Boolean)->Unit){
    ...
    fun getAllDiseasesByMedicalHistoryId(medicalHistoryId: Int, callback: (List<DiseaseResponse>?)->Unit){
        medicalHistoryService.getAllDiseasesByMedicalHistoryId(medicalHistoryId).enqueue(object :
            Callback<List<DiseaseResponse>> {
            override fun onResponse(call: Call<List<DiseaseResponse>>, response: Response<List<DiseaseResponse>>) {
                if (response.isSuccessful) {
                    callback(response.body())
                } else {
                    callback(null)
    ...
    fun addSurgeryToMedicalHistory(medicalHistoryId: Int, surgery: SurgeryRequest, callback: (Boolean)->Unit){
        medicalHistoryService.addSurgeryToMedicalHistory(medicalHistoryId, surgery).enqueue(object :
            Callback<SurgeryResponse> {
            override fun onResponse(call: Call<SurgeryResponse>, response: Response<SurgeryResponse>) {
                if (response.isSuccessful) {
                    callback(true)
                } else {
                    callback(false)
    ...
    fun getAllSurgeriesByMedicalHistoryId(medicalHistoryId: Int, callback: (List<SurgeryResponse>?)->Unit){
        medicalHistoryService.getAllSurgeriesByMedicalHistoryId(medicalHistoryId).enqueue(object :
            Callback<List<SurgeryResponse>> {
            override fun onResponse(call: Call<List<SurgeryResponse>>, response: Response<List<SurgeryResponse>>) {
                if (response.isSuccessful) {
                    callback(response.body())
                } else {
                    callback(null)
    ...
    fun addVaccineToMedicalHistory(medicalHistoryId: Int, vaccine: VaccineRequest, callback: (Boolean)->Unit){
        medicalHistoryService.addVaccineToMedicalHistory(medicalHistoryId, vaccine).enqueue(object :
            Callback<VaccineResponse> {
            override fun onResponse(call: Call<VaccineResponse>, response: Response<VaccineResponse>) {
                if (response.isSuccessful) {
                    callback(true)
                } else {
                    callback(false)
    ...
    fun getAllVaccinesByMedicalHistoryId(medicalHistoryId: Int, callback: (List<VaccineResponse>?)->Unit){
        medicalHistoryService.getAllVaccinesByMedicalHistoryId(medicalHistoryId).enqueue(object :
            Callback<List<VaccineResponse>> {
            override fun onResponse(call: Call<List<VaccineResponse>>, response: Response<List<VaccineResponse>>) {
                if (response.isSuccessful) {
                    callback(response.body())
                } else {
                    callback(null)
